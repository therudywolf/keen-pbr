export const ruTranslation = {
      ...
      pages: {
        ...
        services: {
          title: "Сервисы",
          description:
            "Смотрите, какой outbound использует каждый сервис, и переключайте его между VPN, WAN и другими. Проверяйте маршрут сервиса по запросу или откройте Сканер утечек для полной проверки с обзором.",
          openScanner: "Сканер утечек",
        ...
        leakScanner: {
          title: "Сканер утечек",
          description:
            "Проверьте все сервисы и найдите те, чей трафик идёт через неправильный outbound, затем явно просмотрите и исправьте каждый — без слепых массовых изменений.",
          scan: {
            title: "Сканирование",
            explainer:
              "По запросу проверяет каждый сервис: куда трафик идёт на самом деле и куда должен идти по правилу. Ничего не меняется, пока вы не просмотрите и не подтвердите исправление.",
            action: "Сканировать утечки",
            progress: "Проверено {{done}} / {{total}}",
            summaryLeaking: "Найдено сервисов с утечкой: {{count}}",
            summaryClean: "Утечек не найдено",
          },
          status: {
            goesThrough: "Идёт через",
            expected: "ожидается",
          },
          headers: {
            service: "Сервис",
          ...
          bulk: {
            ...
            fixSelected: "Исправить выбранные",
          },
          fix: {
            action: "Исправить",
            success:
              "Сервисов перенесено на ожидаемый outbound: {{count}}; нажмите Применить.",
          },
          fixDialog: {
            title: "Исправить сервисов: {{count}}",
            description:
              "Каждый сервис ниже будет перенесён обратно на ожидаемый outbound. Изменение сохранится в черновик — нажмите Применить, чтобы оно вступило в силу.",
            movePrefix: "Перенести {{count}} домен(ов) сервиса",
            confirm: "Исправить сервисов: {{count}}",
          },
          clean: {
            title: "Утечек не обнаружено",
            description:
              "Все проверенные сервисы идут через ожидаемый outbound. awoo ⌁",
          },
          messages: {
            noTestable: "Ни у одного сервиса нет записи для проверки.",
          },
        },
        metrics: {
          title: "Метрики",
        ...
        lists: {
          title: "Списки",
          audit: {
            title: "Замечания по спискам",
            advisoryOnly: "только предупреждение — сохранению не мешает",
            recheck: "Проверить заново",
            addresses: "{{formatted}} адресов",
            entries_one: "{{count}} запись, ничего не маршрутизирует",
            entries_few: "{{count}} записи, ничего не маршрутизируют",
            entries_many: "{{count}} записей, ничего не маршрутизируют",
            entries_other: "{{count}} записей, ничего не маршрутизируют",
            shadows: "также перехватывает",
            kind: {
              shadowed_domain: {
                title: "Перекрытые домены",
                description:
                  "Широкая запись в одном списке поглощает точную запись из другого, который ведёт в другую сторону. Широкая выигрывает для всех поддоменов, и точный список выглядит сломанным.",
              },
              oversized_range: {
                title: "Слишком широкие диапазоны",
                description:
                  "Диапазон настолько велик, что тянет за собой посторонние сервисы. Трафик, который вы не собирались заворачивать, идёт следом за списком.",
              },
              unused_list: {
                title: "Списки, которые ничего не маршрутизируют",
                description:
                  "В списке есть записи, но на него не ссылается ни одно включённое правило. Выглядит рабочим, а трафик идёт по умолчанию.",
              },
            },
          },
          description:
